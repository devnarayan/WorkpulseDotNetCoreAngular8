...
namespace CORTNE.Helpers
{
    public class GraphAuthProvider : IGraphAuthProvider
    {
        ...
        public GraphAuthProvider(IConfiguration configuration)
        {
            ...
            //        .WithAuthority(AzureCloudInstance.AzurePublic, AadAuthorityAudience.AzureAdMyOrg, validateAuthority:true)
        ...
        {
            return null;// await _app.AcquireTokenByAuthorizationCode(_scopes, authorizationCode).ExecuteAsync();
        }
    }
